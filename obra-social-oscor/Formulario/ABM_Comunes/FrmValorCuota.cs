...
namespace obra_social_oscor.Formulario.ABM_Comunes
{
    public partial class FrmValorCuota : Form
    {
        ...
        private void ReiniciarFormulario()
        {
            ...
            txtMonto.Text = "";
            txtEdadDesde.Focus();
            btnAgregarVC.Enabled = true;
            btnEditarVC.Enabled = false;
            btnEliminarVC.Enabled = false;
            if (cmbTipoAfiliado.Enabled == false && txtEdadDesde.Enabled == false)
            {
                cmbTipoAfiliado.Enabled = true;
                txtEdadDesde.Enabled = true;
            }
        }
